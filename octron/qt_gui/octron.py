...
#if QT_CONFIG(tooltip)
        self.training_model_list.setToolTip(QCoreApplication.translate("octron_widgetui", u"YOLO models", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.training_imgz_list.setToolTip(QCoreApplication.translate("octron_widgetui", u"Image size used for training within YOLO", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
