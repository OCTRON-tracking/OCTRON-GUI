...
class Ui_octron_prediction_cleaner(object):
    def setupUi(self, octron_prediction_cleaner):
        ...
        self.verticalLayoutWidget_5.setGeometry(QRect(9, 29, 233, 161))
...
"}")
        ...
        self.coverage_label.setMinimumSize(QSize(65, 25))
        self.coverage_label.setMaximumSize(QSize(65, 25))

        self.coverage_layout.addWidget(self.coverage_label)

        self.coverage_percent = QLabel(self.verticalLayoutWidget_5)
        self.coverage_percent.setObjectName(u"coverage_percent")
        self.coverage_percent.setMinimumSize(QSize(40, 25))
        self.coverage_percent.setMaximumSize(QSize(40, 25))
        self.coverage_percent.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)

        self.coverage_layout.addWidget(self.coverage_percent)
        ...
        self.increase_percent_label.setMinimumSize(QSize(40, 25))
        self.increase_percent_label.setMaximumSize(QSize(40, 25))
    ...
    def retranslateUi(self, octron_prediction_cleaner):
        ...
        self.coverage_label.setText(QCoreApplication.translate("octron_prediction_cleaner", u"Coverage:", None))
        self.coverage_percent.setText(QCoreApplication.translate("octron_prediction_cleaner", u"%", None))
