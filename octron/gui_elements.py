...
#if QT_CONFIG(tooltip)
        self.octron.training_model_list.setToolTip(QCoreApplication.translate("self", u"YOLO models", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.octron.training_imgz_list.setToolTip(QCoreApplication.translate("self", u"Image size used for training within YOLO", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
